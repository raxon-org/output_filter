...
namespace Package\Raxon\Org\Output\Filter\Controller;
...
class Cli extends Controller {
    ...
    const INFO = [
        '{{binary()}} raxon_org/output_filter           | Output filter options',
        '{{binary()}} raxon_org/output_filter setup     | Output filter setup',
    ];
